...
ALTER TABLE "account_entity_trackers" DROP COLUMN "id";
ALTER TABLE "account_entity_trackers" ADD CONSTRAINT "account_entity_trackers_tracker_wire_tap_account_id_tracked_account_entity_id_pk" PRIMARY KEY("tracker_wire_tap_account_id","tracked_account_entity_id");--> statement-breakpoint
